...
class FeedbackController extends Controller
{
    ...
    {
        if (!User::hasPermission('viewFeedback', $superAdminAllowed = true)) {
    ...
    public function actionView($id)
    {
        ...
        if (User::hasPermission('viewFeedback', $superAdminAllowed = true) || $model->created_by == Yii::$app->user->id) {
    ...
    public function actionCreate()
    {
        ...
        if (!User::hasPermission('addFeedback', $superAdminAllowed = true)) {
            throw new ForbiddenHttpException('Você não tem permissão para criar feedbacks.');
        }
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->created_by !== Yii::$app->user->id && !User::hasRole('Admin')) {
